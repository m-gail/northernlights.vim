...
let s:red_1 = "#592f2c"
let s:yellow_1 = "#56542f"
let s:green_1 = "#30401e"
let s:cyan_1 = "#004444"
let s:blue_1 = "#2a3c5d"
...
call s:highlight('Search', 'NONE', s:background_alt_3)
call s:highlight('Function', s:cyan, 'NONE')
call s:highlight('Method', s:cyan, 'NONE')
call s:highlight('PreProc', s:green, 'NONE', "bold")
call s:highlight('Statement', s:green, 'NONE')
call s:highlight('Constant', s:cyan, 'NONE')
call s:highlight('Type', s:foreground_alt_1, 'NONE')
call s:highlight('Identifier', s:green, 'NONE')
...
" Diff
call s:highlight('DiffAdd', 'NONE', s:green_1)
call s:highlight('DiffDelete', 'NONE', s:red_1)
call s:highlight('DiffChange', 'NONE', s:blue_1)
call s:highlight('DiffText', 'NONE', s:yellow_1)

" Telescope
hi TelescopeMatching guifg=#6ca632
call s:highlight('TelescopePromptCounter', s:cyan, 'NONE')
...
hi link GitSignsAddInline DiffText
hi link GitSignsChangeInline DiffChange
...
" Which-Key
call s:highlight('WhichKey', s:green, 'NONE', 'bold')
call s:highlight('WhichKeyGroup', s:cyan, 'NONE')
call s:highlight('WhichKeyDesc', s:foreground, 'NONE')
call s:highlight('WhichKeySeparator', s:foreground_alt_2, 'NONE')
call s:highlight('WhichKeyBorder', s:foreground, 'NONE')
call s:highlight('WhichKeyFloat', s:background, 'NONE')
